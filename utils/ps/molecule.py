...
from utils.ps.utils.chem_utils import smi2mol, mol2smi
from utils.ps.utils.chem_utils import get_submol, get_submol_atom_map
...
class Molecule(nx.Graph):
    ...
    def __init__(self, mol: Union[str, RDKitMol] = None, groups: list = None, kekulize: bool = False):
        ...
        if isinstance(mol, str):
            ...
            smiles, rdkit_mol = mol2smi(mol, kekulize), mol
        ...
        for pos, group in enumerate(groups):
            ...
            subgraph_smi = mol2smi(subgraph_mol, kekulize)
    ...
    def to_smiles(self):
        ...
        return mol2smi(rdkit_mol, self.kekulize)
