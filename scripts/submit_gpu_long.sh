#!/bin/bash
# Usage: ./scripts/submit_gpu_long.sh <run_name> [hydra overrides...]
# Example: ./scripts/submit_gpu_long.sh my_run experiment=example_classification dataset=example_cifar10 algorithm=example_classifier
set -euo pipefail
